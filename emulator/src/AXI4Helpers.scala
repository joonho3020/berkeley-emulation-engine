...
//}
//
//class AXI4ToStream(axi: AXI4BundleParameters, streamWidthBits: Int) extends Module {
//  val io = IO(new Bundle {
//    val axi = Flipped(new AXI4BundleParameters(axi))
//    val stream = Decoupled(UInt(streamWidthBits.W))
//  })
//
...
//}
//
///** A helper container to serialize per-stream constants to the header. This is currently somewhat redundant with the
//  * default header emission for widgets.
//  */
...
//  require(
//    BridgeStreamConstants.streamWidthBits >= cpuManagedAXI4params.dataBits,
...
//    ): StreamDriverParameters = prefix(chParams.name) {
//
...
//
//      val outgoingQueueIO = FireSimQueueHelper.makeIO(
//        UInt(BridgeStreamConstants.streamWidthBits.W),
//        chParams.fpgaBufferDepth,
//        isFireSim     = true,
//        overrideStyle = Some(xdc.RAMStyles.ULTRA),
...
//      elaborator:       (DecoupledIO[UInt], A, Int, Int) => StreamDriverParameters,
//    ): Iterable[StreamDriverParameters] = {
//
