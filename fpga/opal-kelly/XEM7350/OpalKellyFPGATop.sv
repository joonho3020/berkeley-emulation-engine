...
module OpalKellyClockCrossingModule(
  ...
  wire _used_procs_cdc_dest_out;
  wire _host_steps_cdc_dest_out;
  xpm_cdc_single #(
    .DEST_SYNC_FF(4),
    .SRC_INPUT_REG(0)
  ) host_steps_cdc (
    .src_clk  (io_host_clock),
    .src_in   (io_host_host_steps[0]),
    .dest_clk (clock),
  ...
  assign io_fpga_host_steps = {15'h0, _host_steps_cdc_dest_out};
  assign io_fpga_used_procs = {2'h0, _used_procs_cdc_dest_out};
endmodule
