...
module OpalKellyClockCrossingModule(
  ...
  always @(posedge io_host_clock) begin
    if (io_host_reset) begin
      sent <= 1'h0;
      sent_1 <= 1'h0;
    end
    else begin
      sent <= _host_steps_cdc_src_rcv | sent;
      sent_1 <= _used_procs_cdc_src_rcv | sent_1;
    end
  end // always @(posedge)
  xpm_cdc_handshake #(
    .DEST_EXT_HSK(1),
    ...
    .src_send (~sent & (|io_host_host_steps)),
    .src_clk  (io_host_clock),
    .dest_ack (_host_steps_cdc_dest_req),
    .dest_clk (clock),
    .dest_out (io_fpga_host_steps),
  ...
  xpm_cdc_handshake #(
    ...
    .src_send (~sent_1 & (|io_host_used_procs)),
    .src_clk  (io_host_clock),
...
module OpalKellyFPGATop(
  ...
  assign io_fpga_io_o_ready = _clock_crossing_io_fpga_io_o_ready;
  assign io_host_io_o_ready_0 = io_host_io_o_ready;
endmodule
