...
// external module XPMCDCHandshakeBlackBox

// external module XPMCDCSingleBlackBox
...
module DecoupledClockCrossingModule(
  ...
  always @(posedge clock)
    src_rcv_prev <= _handshake_cdc_src_rcv;
  XPMCDCHandshakeBlackBox #(
    .DEST_EXT_HSK(1),
    .DEST_SYNC_FF(1),
    .INIT_SYNC_FF(1),
    .SIM_ASSERT_CHK(0),
  ...
  assign io_out_valid = ~src_rcv_prev & _handshake_cdc_src_rcv;
