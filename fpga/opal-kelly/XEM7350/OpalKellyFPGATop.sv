...
module OpalKellyClockCrossingModule(
  ...
  assign io_host_insns_ready = io_fpga_insns_ready;
  assign io_host_io_i_ready = io_fpga_io_i_ready;
  assign io_host_io_o_valid = io_fpga_io_o_valid;
  assign io_host_io_o_bits_0 = io_fpga_io_o_bits_0;
  assign io_fpga_host_steps = io_host_host_steps;
  assign io_fpga_used_procs = io_host_used_procs;
  assign io_fpga_insns_valid = io_host_insns_valid;
  assign io_fpga_insns_bits_0 = io_host_insns_bits_0;
  assign io_fpga_insns_bits_1 = io_host_insns_bits_1;
  assign io_fpga_io_i_valid = io_host_io_i_valid;
  assign io_fpga_io_i_bits_0 = io_host_io_i_bits_0;
  assign io_fpga_io_o_ready = io_host_io_o_ready;
endmodule
...
module OpalKellyEmulatorModuleWrapper(
  ...
  output [15:0] io_i_q_bits_fired,
  output [15:0] io_o_q_bits_fired
);
  ...
  wire [15:0] _GEN_2 =
    {8'h0,
     ...
     _module_io_o_bits_1,
     _module_io_o_bits_0};
  reg  [15:0] i_q_bits_fired;
  reg  [15:0] o_q_bits_fired;
  always @(posedge clock) begin
    ...
    if (reset) begin
      step <= 3'h0;
      i_q_bits_fired <= 16'h0;
      o_q_bits_fired <= 16'h0;
    end
    else begin
      if (_GEN) begin
        if (_GEN_0)
      ...
      if (_GEN_1 & _io_i_q_io_deq_valid)
        i_q_bits_fired <= _io_i_q_io_deq_bits_0;
      if (_io_o_q_io_enq_ready & _GEN_1)
        o_q_bits_fired <= _GEN_2;
    end
  end // always @(posedge)
  ...
  Queue2_Vec1_UInt16 io_o_q (
    ...
    .io_enq_valid  (_GEN_1),
    .io_enq_bits_0 (_GEN_2),
    .io_deq_ready  (~io_o_prev & io_io_o_ready),
    .io_deq_valid  (io_io_o_valid),
    .io_deq_bits_0 (io_io_o_bits_0)
  );
  assign io_i_q_bits_fired = i_q_bits_fired;
  assign io_o_q_bits_fired = o_q_bits_fired;
endmodule
